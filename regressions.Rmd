...
#train_svmVars$defaulted <- as.factor(train_svmVars$defaulted)
#train_svmVars$defaulted[train_svmVars$defaulted == 0] <- -1
...
predictVars <- !(names(train_svmVars) %in% c("defaulted"))
train.svm.pred <- predict(train.svm, train_svmVars[,predictVars])

library(ROCR)

svm.train.pred <- prediction(as.numeric(train.svm.pred),
                             as.numeric(train_svmVars$defaulted))
#plot ROC
svm.train.roc <- performance(svm.train.pred, measure = "tpr", x.measure = "fpr")
plot(svm.train.roc,colorize=FALSE, col="black") # plot ROC curve
lines(c(0,1),c(0,1),col = "gray", lty = 4 )
...
>>>>>>> 8b044876ea388de5a58633d41839e5a353dadf86
